...
<form:form method="POST" action="/createEvent" enctype="multipart/form-data">
    <form:input type="hidden" path="id"/>
    <div class="row">
        <div class="col s4 offset-s4">
            <div class="card blue-grey lighten-3">
                <h1 class="center-align">Create New Event</h1>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col s6">
                        <form:input type="text" path="place"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col s4 offset-s1">
                ...
                <div class="row">
                    ...
                    <div class="col s6">
                        <div class="input-field">
                            <form:input type="text" path="date" name="bdate" class="datepicker"/>
                        </div>
                    </div>
                </div>
                <div class="row">
